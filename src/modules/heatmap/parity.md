...
| Legend (`legend.show`)                                                   | Grafana legend via `addLegendOptions` (governs the cartesian **overlay** series, not the cells) | Partial / different scope |
...
| `legend`                                                                                             | Partial         | Grafana DOM legend governs the cartesian overlay series, not the cells.                                                   |
