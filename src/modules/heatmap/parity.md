...
| `tooltip`                                                                                            | Supported       | Per-cell content rendered by a React `@grafana/ui` `VizTooltip` overlay; overlay rows use their field formatters. Cells have no data-link footer (no clean field mapping). |
