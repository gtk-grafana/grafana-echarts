...
| `tooltip`                                                                                            | Supported                                                                               | Per-cell content rendered by a React `@grafana/ui` `VizTooltip` overlay; overlay rows use their field formatters. Both layouts build one cell per (field, row) pair, so a pinned cell shows that field's data links.                                                                            |
| Tooltip: histogram, color scale                                                                      | none                                                                                    | Not supported                                                                                                                                                                                                                                                                                   |
| Tooltip: max width/height + scroll                                                                   | `tooltip.maxWidth` / `maxHeight` (React `VizTooltip`)                                   | Supported                                                                                                                                                                                                                                                                                       |
| Tooltip: click-to-pin, data links, ad-hoc filters                                                    | React `VizTooltip` footer for the hovered cell's source field + row (annotations: todo) | Supported                                                                                                                                                                                                                                                                                       |
...
| `animation`                                                                                          | Partial                                                                                 | Off by default for every family. `animation.enabled` opts the panel in, but two series override it with a series-level `animation: false` and never animate: the matrix layout's cells, and the binned layout's cartesian overlay. The binned layout's own cell series still honors the opt-in. |
