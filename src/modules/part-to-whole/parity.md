...
| `animation`                                                                                              | Supported       | Always an explicit boolean: Default mode forces `PIE_ANIMATION_ENABLED_DEFAULT` via `applyPartToWholeEditorModeDefaults`; Advanced uses the "Animation" switch (`animation.enabled`). The cartesian density thresholds never apply.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
