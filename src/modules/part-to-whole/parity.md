...
| `tooltip`                                                                                                | Supported       | Rendered by a React `@grafana/ui` `VizTooltip` overlay; the (invisible) ECharts tooltip only drives per-slice hover. Mode maps to `trigger` (item / none). Supports pin, data links, and ad-hoc filters for the hovered slice's field.                                                                                                                                                                                                                                                                                                                                                                                                                                          |
