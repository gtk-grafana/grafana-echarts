...
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Layout algorithm (Layered/Force/Grid) | "Layout" (Force / Circular / Fixed) — `series.graph.layout`                                                 | Partial / different set     | [canvas: fixed coordinates from the data (nodes at the server's x and y, not on a ring)][canvas-graph] (Fixed), [integration: every node is drawn even when the data pins nothing][int-layout], [unit: getGraphLayout][graph-opts]; `force` is deliberately not snapshotted                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | [node-graph-testdata.json][db-testdata] · [#6 live][live-testdata-6] (Circular)                                                                              |
| Zoom mode (Cooperative/Greedy)        | "Zoom" — panel buttons + the `graphRoam` / `sankeyRoam` action (Advanced)                                   | Partial                     | [integration: the roam action scales the view while scroll-to-zoom stays off][int-interaction], [unit: getZoomAction][rel-chart], [unit: resolveRelationsZoom][graph-opts]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | [readability.json][db-read] · [#8 live][live-read-8]                                                                                                         |
...
| —                                     | Repulsion / Edge length / Gravity — `series.graph.force.*` (Advanced)                                       | ECharts-only                | [unit: getGraphForce][graph-opts]; the layout itself is only asserted to be _reproducible_ ([integration: two renders of the same frames draw identical calls][int-layout])                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | [readability.json][db-read] · [#10 live][live-read-10]                                                                                                       |
...
| —                                     | "Edge arrows" — `series.graph.edgeSymbol` (Advanced, **on**)                                                | ECharts-only                | [canvas: arrows off (plain lines, no heads)][canvas-graph], [unit: getGraphEdgeSymbol][graph-opts]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | [readability.json][db-read] · [#2 live][live-read-2]                                                                                                         |
| —                                     | "Show edge values" — `series.*.edgeLabel` (Advanced)                                                        | ECharts-only                | [canvas: edge values on (a weight drawn at each link's midpoint)][canvas-graph], [canvas: edge values on (a weight drawn on each ribbon)][canvas-sankey], [unit: getRelationsEdgeLabel][graph-opts]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | [readability.json][db-read] · [#8 live][live-read-8]                                                                                                         |
...
| —                                     | "Hide overlapping labels" — `series.labelLayout.hideOverlap` (Default, **on**)                              | ECharts-only                | [integration: a node label that would collide with one already drawn is dropped][int-labels], [integration: a chord ring of collapsed arcs drops the labels that stack up][int-labels], [unit: getRelationsLabelLayout][graph-opts]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | [readability.json][db-read] · [#2 live][live-read-2] vs [#3 live][live-read-3]                                                                               |
| —                                     | "Label overflow" / "Label width" — `label.overflow` / `label.width` (Advanced)                              | ECharts-only                | [integration: a long name is cut at the label width and ends in an ellipsis][int-labels], [integration: break mode wraps a long name over several lines instead of cutting it][int-labels], [unit: getRelationsLabelStyle][graph-opts]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | [readability.json][db-read] · [#2 live][live-read-2] vs [#3 live][live-read-3]                                                                               |
...
| —                                     | "Time slider" — read every mark at one timestamp (Default tier)                                             | ECharts-only                | [canvas: the graph at the earliest timestamp, under the slider strip (edge weights 1 and 10)][canvas-timeline], [integration: builds a different graph at an earlier timestamp than the reducer draws][int-timeline], [integration: repaints the chart when the slider is moved][int-timeline], [integration: shortens the chart by exactly the strip][int-timeline], [unit: takes each mark's value at the selected row rather than reducing][ng-conv], [unit: unions every frame's stops, ascending and deduped][ng-conv], [unit: resolves the timestamp against each frame's own row dimension][ng-conv], [unit: is hidden on instant data][ed-timeline], [unit: stays visible on instant data once it is already on][ed-timeline], [unit: labels the main row Value under the time slider, on nodes and edges alike][tip-marks] | [timeline.json][db-timeline] · [#1 live][live-timeline-1] vs [#5 live][live-timeline-5] (chord, the variant that morphs)                                     |
| —                                     | "Playback step" / "Playback step size" — how long a step lasts and how far it moves (Advanced, slider only) | ECharts-only                | [unit: advances one stop per step duration][playback], [unit: honours the configured step duration][playback], [unit: loops back to the first stop at the end][playback], [unit: keeps a steady cadence while the selection moves under it][playback] , [unit: stops when the user takes hold of the slider][playback] , [unit: advances by the configured number of stops][playback], [unit: lands on the final stop before looping, even from an overshooting step][playback], [unit: scales with the length of the timeline][playback]                                                                                                                                                                                                                                                                                           | [timeline.json][db-timeline] · [#1 live][live-timeline-1]                                                                                                    |
...
**Playback step size is a percentage, not a count of stops.** The count belongs to the
response — the same panel carries five stops over an hour and three hundred over a week —
so a count would mean something different on each, while "cross the window in twenty
steps" reads the same way on both. It floors at one stop (`stopsPerStep`), which is what
makes the 1% default the original one-stop walk on any timeline of a hundred stops or
fewer. Playback only: dragging still lands on any timestamp, so a coarse step buys a
faster play-through without coarsening manual control.
...
name, No value, Thresholds, Value mappings, Data links, Filterable), customizing Color
(PaletteClassic, byValue + bySeries) and un-hiding Filterable from the defaults section.
Core's Node graph keeps the full set too, but routes stat units through its own panel
options rather than the standard Unit.
...
| Value mappings | **Yes**          | Applied through the field's display processor, so a mapping targets **one mark** — a node can read `Healthy` while its neighbour reads a number — and reaches the "Show node values" label as well as the tooltip.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | [unit: value mappings][mappings]                                                                                                                                                                                                               | —                                                                                              |
...
[playback]: ../../lib/components/hooks/useTimelinePlayback.test.ts
