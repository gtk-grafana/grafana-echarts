...
| —                                     | "Playback step" — ms between steps while playing (Advanced, slider only)       | ECharts-only                | [unit: advances one stop per step duration][playback], [unit: honours the configured step duration][playback], [unit: loops back to the first stop at the end][playback], [unit: keeps a steady cadence while the selection moves under it][playback] , [unit: stops when the user takes hold of the slider][playback]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | [timeline.json][db-timeline] · [#1 live][live-timeline-1]                                                                                                    |
