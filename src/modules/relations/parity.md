...
| —                                             | "Pan" — `series.*.roam: 'move'` (Default, off)                                                                                 | ECharts-only                | [unit: resolveRelationsRoam][graph-view], [unit: emits move roam when panning is on][graph-opts], [unit: honors the interaction switches][sankey-opts]; the drag itself needs e2e                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | [readability.json][db-read] · [#8 live][live-read-8]                                                                                                                                 |
