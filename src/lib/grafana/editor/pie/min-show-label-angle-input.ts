...
import { PIE_MIN_SHOW_LABEL_ANGLE_DEFAULT, pieMinShowLabelAnglePath } from 'editor/constants';
 ...
 * `series.minShowLabelAngle`) in the "Advanced" category. Hides labels on slices
