 ...
 * falls back to our fully-opaque default rather than ECharts' faint 0.45 — see
 * `PARALLEL_LINE_OPACITY_DEFAULT`. Shown only when parallel is the selected chart
 * type. Rendered by `getParallelLineStyle`.
 */
export function addParallelLineOpacityOptions(builder: PanelOptionsEditorBuilder<PanelOptions>) {
  addAdvancedNumberInput(builder, {
    ...
    name: 'Line opacity',
    description: 'Opacity of the polylines (0–100). Empty is fully opaque.',
