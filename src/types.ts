 ...
 *
 * `RelationsPanelOptions` contributes the relations family's ~36 keys, declared beside
 * that family's other editor types (`editor/relations/options.ts`) rather than inline
 * here. Consumers are unaffected — they still import `PanelOptions` and see one flat
 * option bag.
 *
